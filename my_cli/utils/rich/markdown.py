...
class TableHeaderElement(MarkdownElement):
    """对应 `thead_open` 和 `thead_close` 的 Markdown 元素"""
...
class TableBodyElement(MarkdownElement):
    """对应 `tbody_open` 和 `tbody_close` 的 Markdown 元素"""
...
class TableRowElement(MarkdownElement):
    """对应 `tr_open` 和 `tr_close` 的 Markdown 元素"""
...
class TableDataElement(MarkdownElement):
    """对应 `td_open`/`td_close` 和 `th_open`/`th_close` 的 Markdown 元素"""
...
__all__ = ["Markdown", "MarkdownContext", "MarkdownElement"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("path", metavar="PATH", help="path to markdown file, or - for stdin")
    parser.add_argument("-c", "--force-color", dest="force_color", action="store_true", default=None)
    parser.add_argument("-t", "--code-theme", dest="code_theme", default=_KIMI_ANSI_THEME_NAME)
    parser.add_argument("-i", "--inline-code-lexer", dest="inline_code_lexer", default=None)
    parser.add_argument("-y", "--hyperlinks", dest="hyperlinks", action="store_true")
    parser.add_argument("-w", "--width", type=int, dest="width", default=None)
    parser.add_argument("-j", "--justify", dest="justify", action="store_true")
    parser.add_argument("-p", "--page", dest="page", action="store_true")
