...
对应源码：kimi-cli-fork/src/kimi_cli/ui/shell/update.py
"""
...
async def _do_update(*, print: bool, check_only: bool) -> UpdateResult:
    from my_cli.constant import VERSION as current_version
    ...
    async with new_client_session() as session:
        ...
        with tempfile.TemporaryDirectory(prefix="my-cli-") as tmpdir:
    ...
    _print("[yellow]Restart CLI to use the new version.[/yellow]")
    return UpdateResult.UPDATED


__all__ = ["UpdateResult", "do_update", "semver_tuple"]
